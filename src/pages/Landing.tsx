...
export default function Landing() {
  ...
  return <div className="love-story">
    ...
    <FloatingHearts />
    {opened && <div className="chapter-progress" aria-label={`${chapterProgress}% of our story completed`}><span style={{ width: `${chapterProgress}%` }} /></div>}
